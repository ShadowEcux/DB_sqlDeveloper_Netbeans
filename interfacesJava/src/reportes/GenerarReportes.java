...
public class GenerarReportes {
    ...
    public void reporteSalida(String nume) {
        ...
        try {
            ...
            parametro.put("logo", this.getClass().getResourceAsStream("/imagenes/cpu_minim.png"));
            parametro.put("logo2", this.getClass().getResourceAsStream("/imagenes/cpu_minim.png"));
    ...
    public void reporteEnvio(String nume) {
        ...
        try {
            ...
            parametro.put("cpu", this.getClass().getResourceAsStream("/imagenes/cpu.png"));
